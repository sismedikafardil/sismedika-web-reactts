    ...
    <section className={`w-full py-12 ${className}`}>
      <div className="container mx-auto px-[5%]">
        ...
        <div className="relative">
          ...
          <div ref={reveal.ref} className="space-y-8 md:space-y-0 md:grid md:grid-cols-9 md:gap-6">
            {milestones.map((m, i) => {
            ...
            {/* map milestone at end */}
            <M variants={reveal.variants.item} initial="hidden" animate={reveal.inView ? 'show' : 'hidden'} className="md:col-span-9 flex justify-center mt-6">
              <div className="flex items-center gap-4">
                <img src={'/assets/indonesia-map.png'} alt="Indonesia map" className="h-24 w-auto opacity-90 rounded-lg shadow-sm" />
